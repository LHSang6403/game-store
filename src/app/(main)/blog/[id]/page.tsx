    ...
    <div className="flex min-h-screen w-full flex-col items-center gap-4 rounded-3xl bg-gradient-to-t from-accent">
      {isLoading ? (
        ...
        <>
          {isSuccess && blog.data && (
            <>
              <h1 className="mt-6 max-w-[900px] bg-gradient-to-r from-cpurple via-cpink to-corange bg-clip-text px-8 text-center text-3xl font-bold text-transparent xl:px-6 sm:px-2">
                {blog.data.title}
              </h1>
