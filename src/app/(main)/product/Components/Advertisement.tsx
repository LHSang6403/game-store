...
export default function Advertisement() {
  return (
    <div className="w-full min-h-[70vh] max-h-[90vh] xl:h-screen relative bg-foreground">
      ...
      <div className="absolute z-0 bottom-16 xl:bottom-24 left-40 lg:left-12 h-44 w-44 rounded-full grid grid-cols-10 gap-1 sm:opacity-60 bg-gradient-to-l from-[#07BCDD] to-hsl(222.2, 84%, 4%)"></div>
      <div className="absolute z-0 bottom-20 xl:bottom-28 left-44 lg:left-20 h-48 w-48 rounded-full grid grid-cols-10 gap-1 opacity-70 sm:opacity-50 bg-gradient-to-r from-[#FD5E4F] to-hsl(222.2, 84%, 4%)"></div>
      <div className="absolute z-0 bottom-10 xl:bottom-20 left-48 lg:left-28 h-44 w-44 rounded-full grid grid-cols-10 gap-1 opacity-60 sm:opacity-40 bg-gradient-to-b from-[#FFB718] to-hsl(222.2, 84%, 4%)"></div>
      <img
        src="/assets/images/gameIcon/i2.png"
        alt="Promotion"
        className="absolute bottom-28 xl:bottom-36 left-56 lg:left-32 h-20 w-20 sm:opacity-80"
      ></img>
      ...
      <div className="absolute bottom-20 xl:bottom-32 lg:bottom-24 right-28 lg:right-2 w-80 sm:w-72 h-44 px-2 text-background/90 hover:text-background">
