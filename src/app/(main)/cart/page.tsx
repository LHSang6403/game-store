...
export default function Page() {
  return (
    <div className="relative flex min-h-screen w-full flex-col gap-4 px-10 pb-10 xl:px-6 sm:px-4">
      ...
      <h1 className="mt-4 bg-gradient-to-r from-[#02A9FF] to-[#8538F8] bg-clip-text text-center text-3xl font-semibold text-transparent">
        Sản phẩm đã chọn
      </h1>
      <OrderCurrent />
