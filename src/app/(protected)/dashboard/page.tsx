...
export default function page() {
  ...
  return (
    <main className="flex w-full flex-col gap-2 py-0 md:gap-4 md:pb-4 md:pt-2">
      <div className="flex w-full flex-col gap-2 md:gap-4 xl:flex-row">
        <div className="flex w-full flex-col gap-2 md:gap-4 xl:w-1/2">
