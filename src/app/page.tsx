          ...
          <div className="flex h-auto w-full flex-col items-center px-10 xl:px-4 sm:px-2">
            ...
            <div className="flex w-full flex-col items-start gap-4 px-36 xl:px-4 sm:px-2">
              ...
              <p className="font-light sm:text-sm">
                Các sản phẩm bán chạy tại 2Win luôn là những thiết bị được game
                thủ ưa chuộng nhất, nổi bật với chất lượng vượt trội và tính
                năng đột phá. Những chiếc máy chơi game mới nhất từ PlayStation,
                Xbox và Nintendo luôn nằm trong top lựa chọn của khách hàng. Hãy
                đến với chúng tôi để khám phá những sản phẩm hot nhất và nâng
                cấp trải nghiệm chơi game của bạn!
              </p>
            </div>
            <div className="my-10 flex w-full flex-row px-36 xl:px-4 lg:flex-col sm:px-2">
              <div className="w-1/2 lg:w-full">
                ...
                <p className="mt-4 max-w-[450px] text-sm">
                  PlayStation 5 (PS5) là đỉnh cao của công nghệ chơi game, mang
                  đến trải nghiệm chơi game đột phá và hiệu suất vượt trội.
                </p>
                <p className="mt-2 max-w-[450px] text-sm">
                  Với thiết kế hiện đại và mạnh mẽ, PS5 được trang bị bộ vi xử
                  lý AMD Ryzen Zen 2 và GPU RDNA 2, hỗ trợ đồ họa 4K chân thực
                  và tốc độ khung hình lên đến 120fps.
                </p>
              </div>
              <div className="w-1/2 lg:w-full">
                ...
                <p className="mt-4 max-w-[450px] text-sm">
                  PlayStation 4 Slim (PS4 Slim) là phiên bản tinh gọn của dòng
                  PS4, mang lại hiệu suất ổn định và thiết kế nhỏ gọn, tiết kiệm
                  không gian.
                </p>
                <p className="mt-2 max-w-[450px] text-sm">
                  Với bộ vi xử lý AMD Jaguar 8 nhân và GPU AMD GCN, PS4 Slim hỗ
                  trợ đồ họa Full HD và hiệu suất chơi game mượt mà. Máy còn
                  được trang bị ổ cứng dung lượng lớn, cho phép lưu trữ nhiều
                  trò chơi và dữ liệu.
                </p>
              </div>
            </div>
            ...
            <div className="relative w-full">
              ...
              <div className="absolute left-0 right-0 top-32 h-fit w-full xl:top-16">
                ...
                <p className="mt-4 text-center font-light text-[#B5B3BA] xl:px-6 sm:px-4 sm:text-sm">
                  ...
                  <br className="xl:hidden"></br> Từ tay cầm, tai nghe, đế sạc,
                  túi đựng máy chơi game đến các phụ kiện khác, tất cả đều đảm
            ...
            <div className="z-20 mt-96 grid h-full w-fit grid-cols-2 xl:mt-56 lg:mt-64 lg:w-full">
              <div className="flex w-full flex-col justify-center gap-4 pl-28 lg:col-span-2 lg:pl-6">
                ...
                <p className="text-sm text-[#B4B3BA] lg:pr-4">
                  ...
                  <br className="lg:hidden"></br> bạn chơi game ở ba chế độ khác
                  nhau: chế độ TV<br className="lg:hidden"></br> khi kết nối với
                  dock để chơi trên màn hình lớn, chế độ
                  <br className="lg:hidden"></br> tabletop với chân đế tích hợp
                  để chơi cùng bạn bè ở<br className="lg:hidden"></br> bất kỳ
                  đâu.
                </p>
              </div>
              <div className="">
              ...
              <div className="flex flex-col justify-center gap-4 pl-28 lg:col-span-2 lg:pl-6">
                ...
                <p className="text-sm text-[#B4B3BA] lg:pr-4">
                  ...
                  <br className="lg:hidden"></br> Xbox Series X hỗ trợ độ phân
                  giải lên đến 4K và<br className="lg:hidden"></br> tốc độ khung
                  hình 120fps, đảm bảo trải nghiệm
                  <br className="lg:hidden"></br> chơi game mượt mà và chân
                  thực. Với ổ cứng<br className="lg:hidden"></br> SSD 1TB NVMe.
                </p>
              </div>
            </div>
          </div>
          <div className="mt-20 flex h-auto w-full flex-col items-center px-10 xl:mt-10 xl:px-6 sm:px-4">
            <div className="mt-16 flex flex-col items-center gap-4">
              ...
              <p className="text-center font-light sm:text-sm">
                Tại Gaming Paradise, chúng tôi cam kết mang đến cho khách hàng
                những sản phẩm chơi game<br className="xl:hidden"></br> với giá
                thành hợp lý nhất. Với các chương trình khuyến mãi thường xuyên
                và chính sách giá cạnh tranh,
                <br className="xl:hidden"></br> bạn luôn có thể yên tâm mua sắm
            ...
            <div className="mt-20 flex flex-col items-center gap-4">
              ...
              <p className="text-center font-light sm:text-sm">
                Dù bạn yêu thích thể loại hành động, phiêu lưu, chiến thuật hay
                thể thao, chúng tôi đều có những tựa game phù hợp với bạn.
                <br className="xl:hidden"></br> Các trò chơi nhập vai sẽ đưa bạn
                vào những câu chuyện sâu sắc và kỳ ảo, trong khi các game chiến
                thuật đòi hỏi sự tư duy và tính toán cẩn thận.
              </p>
            </div>
            <div className="mt-20 grid h-full grid-cols-2 items-center gap-10 xl:mt-10 lg:grid-cols-1">
              <div className="flex h-full max-w-[500px] flex-col items-start justify-center gap-6 pl-10 lg:max-w-full lg:pl-0">
                ...
                <p className="text-sm font-light">
                  ...
                  <br className="lg:hidden"></br> cho bất kỳ game thủ nào, mang
                  lại sự tiện lợi<br></br> và linh hoạt trong việc truy cập và
                  tận hưởng<br className="lg:hidden"></br> các tựa game yêu
                  thích. Với các đĩa chơi game như PlayStation Network Card,
                  Xbox Live Gift Card,
                  <br className="lg:hidden"></br> bạn có thể dễ dàng nạp tiền
                  vào tài khoản game
                  <br className="lg:hidden"></br> của mình để mua trò chơi, nội
                  dung tải về (DLC),
                  <br className="lg:hidden"></br> và các dịch vụ trực tuyến
                  khác.
                </p>
              </div>
              ...
              <div className="flex h-full max-w-[500px] flex-col items-start justify-center gap-6 pl-10 lg:max-w-full lg:pl-0">
                ...
                <p className="text-sm font-light">
                  ...
                  <br className="lg:hidden"></br> thẻ chơi game còn mang lại
                  nhiều ưu đãi<br className="lg:hidden"></br> và khuyến mãi hấp
                  dẫn từ các nhà phát hành.<br className="lg:hidden"></br> Sử
                  dụng thẻ chơi game, bạn có thể hưởng lợi
                  <br className="lg:hidden"></br> từ các đợt giảm giá, sự kiện
                  đặc biệt và các gói
                  <br className="lg:hidden"></br> nội dung độc quyền, giúp tối
                  ưu hóa trải nghiệm
